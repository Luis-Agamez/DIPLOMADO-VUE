...
<section class="text-gray-700 body-font overflow-hidden bg-white">
  <div class="container px-5 py-24 mx-auto">
    <div class="lg:w-4/5 mx-auto flex flex-wrap">
      <!--<img alt="ecommerce" class="lg:w-1/2 w-full object-cover object-center rounded border border-gray-200" src="https://www.creativosonline.org/wp-content/uploads/2021/09/Crear-la-portada-y-contraportada-de-un-libro-2.jpg">-->
      
      <img alt="ecommerce" class="lg:w-1/2 w-full  object-cover object-center rounded border border-gray-200" :src="book.imgUrl">
      <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <div class="flex mb-4">
          <span class="flex items-center">
            ...
            <span class="text-gray-600 ml-3">{{ book.rating }} Reviews</span>
          </span>
        ...
        <div class="flex-col">
          ...
          <div class="inline-flex items-center mt-2 ml-10">
      <button
      @click="counter--"
...
<div class="w-full">
  <RouterLink to="/pay">
    <button
      class="py-2 px-4 bg-orange-700 text-white rounded hover:bg-orange-900 active:bg-orange-900 disabled:opacity-50 mt-4 w-full flex items-center justify-center"
    >
      Alquilar
    </button>
  </RouterLink>
